window.onload = function()
{
	...
	function init()
	{
		...
		canvas.style.backgroundColor = "#9AFFC7";
	...
	function gameOver()
	{
		...
		context.strokeText("Appuyer sur Espace pour rejouer", centerX, 500);
		context.fillText("Appuyer sur Espace pour rejouer", centerX, 500);
		context.restore();
	}
